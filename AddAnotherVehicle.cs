...
namespace VRMS___Management__12_01_21_
{
    public partial class AddAnotherVehicle : Form
    {
        ...
        private void txtOperatorID_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                OdbcCommand cmd = new OdbcCommand("SELECT type,school_id,fname,mname,lname,suf FROM registered_owners WHERE owner_id = '"+ txtOperatorID.Text +"';",con);
                ...
                string fname = dt.Rows[0][2].ToString();
                string mname = dt.Rows[0][3].ToString();
                string lname = dt.Rows[0][4].ToString();
                string suf = dt.Rows[0][5].ToString();
                string full = fname + "" + mname + "" + lname + "" + suf;
                label14.Text = full;
                nameVal.Text = full;
        ...
        private void gunaAdvenceButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(" KINDLY INPUT THE  PLATE NUMBER OF YOUR VEHICLE");
            }
            else if (cmbWheels.Text == "")
            {
                MessageBox.Show(" KINDLY INPUT THE TYPE OF YOUR VEHICLE");
            }
            else
            {
                this.Hide();
                try
                {
                    ...
                    else
                    {
                        ...
                        print.lblID.Text = txtOwnerID.Text;
                        print.lblFullname.Text = nameVal.Text;
                        print.lblCompanyID.Text = label11.Text;
                        print.Show();
                    }
                }
